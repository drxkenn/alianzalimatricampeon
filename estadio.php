...
<div class="page-header">
  <h1 class="display-5">Estadio Alejandro Villanueva</h1>
    ...
    <div class="col-12">
      <div class="card shadow-sm border-0 rounded-3 overflow-hidden">
        ...
        <div class="card-body p-4">
          <h2 class="fw-bold mb-3" style="color: var(--alianza-blue);">Nuestra Casa</h2>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-6">
      <div class="card shadow-sm border-0 rounded-3 h-100">
        <div class="card-body">
          <h3 class="fw-bold mb-4" style="color: var(--alianza-blue);">Datos del Estadio</h3>
    ...
    <div class="col-md-6">
      <div class="card shadow-sm border-0 rounded-3 h-100">
        <div class="card-body">
          <h3 class="fw-bold mb-4" style="color: var(--alianza-blue);">Tribunas</h3>
    ...
    <div class="col-12">
      <div class="card shadow-sm border-0 rounded-3 overflow-hidden">
        ...
        <div class="card-body text-center p-4">
          <h5 class="fw-bold mb-3" style="color: var(--alianza-blue);">Ubicación</h5>
